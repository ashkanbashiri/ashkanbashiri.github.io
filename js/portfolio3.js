...
var cy3 = 0;
var time3 = 0;
const interval3 = 60; //update every 20 miliseconds
const sim_speed3 = 1;
...
function kf_step() {
  ...
  omega3 =
    kp_w3 *
    Math.atan2(Math.sin(theta_g3 - theta3), Math.cos(theta_g3 - theta3));
  omega3 =
    (Math.abs(omega3) / omega3) * Math.min(Math.abs(omega3), Math.PI / 3);
...
function drawChart5() {
  ...
  if (chart5 == null) {
    chart5 = new google.visualization.LineChart(
...
function drawStuff5() {
  ...
  data5.addRows([[time3, kf_error, sens1_error, sens2_error]]);
...
function drawChart6() {
  // Instantiate and draw our chart, passing in some options.
  if (chart6 == null) {
    chart6 = new google.visualization.LineChart(
